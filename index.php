...
-->
  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="main-content">
              ...
              <h6>Opening on Friday, August 23rd</h6>
              <h2>Dieng Culture Festival 2024</h2>
          ...
          <div class="col-lg-4">
            <div class="venue-item">
              ...
              <div class="down-content">
                <div class="left-content">
                  <div class="main-white-button">
                    <a href="ticket-details-lalalafest.html"
                      >Purchase Tickets</a
                    >
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="event-item">
              ...
              <div class="down-content">
                <a href="event-details.php"><h4>LaLaLa Festival</h4></a>
                <ul>
          ...
          <div class="col-lg-4">
            <div class="event-item">
              ...
              <div class="down-content">
                <a href="event-details.php"><h4>Nexfest</h4></a>
                <ul>
          ...
          <div class="col-lg-4">
            <div class="event-item">
              ...
              <div class="down-content">
                <a href="event-details.php"><h4>Forestra</h4></a>
                <ul>
    ...
    <script>
      var countDownDate = new Date("August 23, 2024 15:00:00").getTime();
